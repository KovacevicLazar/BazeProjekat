...
-- --------------------------------------------------
-- Date Created: 03/19/2021 22:10:32
...
CREATE TABLE [dbo].[Smene] (
    [ID] int IDENTITY(1,1) NOT NULL,
    [NazivSmene] nvarchar(25)  NOT NULL,
...
CREATE INDEX VSJ_Naziv_Idx ON [dbo].Vatrogasne_Jedinice (Naziv);
...
CREATE INDEX Radnik_JMBG_Idx ON [dbo].Radnici (JMBG);
...
CREATE TRIGGER [dbo].[Trigger_Vozilo_ioU] ON  [dbo].[Vozila]
   INSTEAD OF UPDATE
AS 
	declare @Id int;
